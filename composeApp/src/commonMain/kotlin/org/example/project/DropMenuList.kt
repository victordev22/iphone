...
data class MenuItemDataList(val text: String, val icon: ImageVector)
...
fun DropdownMenuList() {
    ...
    val menuItems = listOf(
        MenuItemDataList("Encendidas", Icons.Filled.Edit),
        MenuItemDataList("Tarde", Icons.Filled.Settings),
        MenuItemDataList("Menos horas", Icons.Filled.Delete)
    )
